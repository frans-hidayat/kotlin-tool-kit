...
import com.frame.kotlintoolkit.presentation.indicatorseekbar.utils.IndicatorStayLayout;
import com.frame.kotlintoolkit.presentation.indicatorseekbar.utils.IndicatorType;
import com.frame.kotlintoolkit.presentation.indicatorseekbar.utils.TickMarkType;
...
public class JavaBuildFragment extends BaseFragment {
    ...
    protected void initView(View root) {
        ...
        IndicatorSeekBar continuous = IndicatorSeekBar
                ...
                .min(10)
                .progress(33)
                .indicatorColor(ContextCompat.getColor(requireContext(), R.color.color_blue))
                .indicatorTextColor(Color.parseColor("#ffffff"))
                .showIndicatorType(IndicatorType.CIRCULAR_BUBBLE)
                .thumbColorStateList(ContextCompat.getColorStateList(requireContext(), R.color.selector_thumb_color))
                .thumbSize(14)
                .trackProgressColor(ContextCompat.getColor(requireContext(), R.color.colorAccent))
                .trackProgressSize(4)
                .trackBackgroundColor(ContextCompat.getColor(requireContext(), R.color.color_gray))
                .trackBackgroundSize(2)
                .showThumbText(true)
                .thumbTextColor(ContextCompat.getColor(requireContext(), R.color.color_gray))
                .build();
        ...
        IndicatorSeekBar continuous2TickTexts = IndicatorSeekBar
                ...
                .showTickTexts(true)
                .indicatorColor(ContextCompat.getColor(requireContext(), R.color.color_gray))
                .indicatorTextColor(Color.parseColor("#ffffff"))
        ...
        IndicatorSeekBar discrete_ticks_texts = IndicatorSeekBar
                ...
                .tickMarksColor(ContextCompat.getColor(requireContext(), R.color.color_blue))
                .tickMarksSize(13)//dp
                .showTickTexts(true)
                .tickTextsColor(ContextCompat.getColor(requireContext(), R.color.color_pink))
                .tickTextsSize(13)//sp
                ...
                .thumbColor(ContextCompat.getColor(requireContext(), R.color.colorAccent))
                .thumbSize(14)//dp
                .trackProgressColor(ContextCompat.getColor(requireContext(), R.color.colorAccent))
        ...
        IndicatorSeekBar discrete_ticks_texts1 = IndicatorSeekBar
                ...
                .showTickTexts(true)
                .tickTextsColorStateList(ContextCompat.getColorStateList(requireContext(), R.color.selector_tick_texts_3_color))
                .indicatorColor(ContextCompat.getColor(requireContext(), R.color.color_blue))
                .indicatorTextColor(Color.parseColor("#ffffff"))
                .showIndicatorType(IndicatorType.RECTANGLE)
                .thumbColor(Color.parseColor("#ff0000"))
        ...
        IndicatorSeekBar discrete_ticks_texts_ends = IndicatorSeekBar
                ...
                .tickCount(7)
                .showTickMarksType(TickMarkType.OVAL)
                .tickMarksColor(ContextCompat.getColorStateList(requireContext(), R.color.selector_tick_marks_color))
                ...
                .thumbColor(Color.parseColor("#ff0000"))
                .thumbSize(14)
                .trackProgressColor(ContextCompat.getColor(requireContext(), R.color.color_blue))
                .trackProgressSize(4)
                .trackBackgroundColor(ContextCompat.getColor(requireContext(), R.color.color_pink))
                .trackBackgroundSize(2)
                .build();
