package com.frame.kotlintoolkit.presentation.indicatorseekbar.utils;
...
public class IndicatorSeekBar extends View {
    ...
    private void measureTickTextsBonds() {
        if (needDrawText()) {
            ...
            mTickTextsHeight = mRect.height() + SizeUtils.dp2px(mContext, 10);//with the gap(3dp) between tickTexts and track.
        }
    }
    ...
    private void refreshSeekBarLocation() {
        ...
        if (needDrawText()) {
            mTextPaint.getTextBounds("j", 0, 1, mRect);
            mTickTextY = mPaddingTop + mCustomDrawableMaxHeight + Math.round(mRect.height() - mTextPaint.descent()) + SizeUtils.dp2px(mContext, 10);
    ...
    private void initTickMarksColor(ColorStateList colorStateList, int defaultColor) {
        ...
        if (colorStateList == null) {
            ...
            mUnSelectedTickMarksColor = Color.RED;
            return;
        }
        int[][] states = null;
        int[] colors = null;
